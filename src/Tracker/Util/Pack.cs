...
namespace Tracker.Util
{
    public static class Pack
    {
        ...
        public static byte[] Int16(Int16 i, Endianness e = Endianness.Big)
        {
        ...
        public static byte[] Int32(Int32 i, Endianness e = Endianness.Big)
        {
            byte[] bytes = BitConverter.GetBytes(i);
        ...
        public static byte[] Int64(Int64 i, Endianness e = Endianness.Big)
        {
            byte[] bytes = BitConverter.GetBytes(i);
        ...
        public static byte[] UInt16(UInt16 i, Endianness e = Endianness.Big)
        {
            byte[] bytes = BitConverter.GetBytes(i);
        ...
        public static byte[] UInt32(UInt32 i, Endianness e = Endianness.Big)
        {
            byte[] bytes = BitConverter.GetBytes(i);
        ...
        public static byte[] UInt64(UInt64 i, Endianness e = Endianness.Big)
        {
            byte[] bytes = BitConverter.GetBytes(i);
